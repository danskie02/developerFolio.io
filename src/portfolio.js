...
const greeting = {
  username: "Danskie",
  title: "Hi Good Day!, I'm Mark Daniel Ponce",
  subTitle: emoji(
    "A passionate Full Stack Software Developer 🚀 having an experience of building Web and Mobile applications with JavaScript / Dart / Reactjs / Nodejs / React Native / Flutter and some other cool libraries and frameworks. I'm also a Networking and Ethical Hacking Enthusiast, worked with CISCO Packet Tracer / Wireshark / NMap / Metasploit / Ethercap and other penetration testing tools."
  ),
  resumeLink:
...
const skillsSection = {
  ...
  skills: [
    ...
    emoji(
      "⚡ Integration of third party services such as Firebase and Supabase for remote databases"
    ),
    emoji(
      "⚡ Test web app deployments using GitHub and Render"
    )
  ],
...
// Networking & Cybersecurity Skills Section
export const networkingSkillsSection = {
  title: "Networking & Cybersecurity",
  subTitle: "PASSIONATE ABOUT NETWORKS, SECURITY, AND PENETRATION TESTING",
  skills: [
    emoji("🔒 Experience with penetration testing and vulnerability assessment"),
    emoji("🕵️‍♂️ Familiar with ethical hacking methodologies and tools"),
    emoji("🌐 Network configuration, monitoring, and troubleshooting"),
    emoji("🛡️ Hands-on with CISCO Packet Tracer, Wireshark, NMap, Metasploit, and more")
  ],
  softwareSkills: [
    {
...
const educationInfo = {
  ...
  schools: [
    ...
    {
      schoolName: "DOST SEI's Scholars Leadership Camp (SLC)",
      logo: require("./assets/images/DOST_SEI.jfif"),
      subHeader: "Leadership Camp Exclusive for DOST Scholars",
      duration: " June 2025",
      desc: "Conducted workshops and seminars on leadership development focused on three core values;",
      descBullets: ["Professional Excellence", "Social Responsibility", "Servant Leadership"],
    },
    {
      schoolName: "DOST SEI's Scholars Research Camp (SRC)",
      logo: require("./assets/images/DOST_SEI.jfif"),
      subHeader: "Research Camp Exclusive for DOST Scholars",
      duration: " December 2025",
      desc: "Conducted workshops and seminars on research development and publication, focused on;",
      descBullets: ["Writing Publishable Research Papers", "Distinguishing Predatory Journals", "Publishing Research in Reputable Journals"],
    },
  ]
};
...
const workExperiences = {
  ...
  experience: [
    ...
    {
      role: "Schools Division Office Marinduque Intern",
      company: "IT Department (SDO)",
      companylogo: require("./assets/images/DepEdMdq_logo.jfif"),
      date: "January 2026 - April 2026",
      desc: "Worked under the supervision of the SDO IT Department Head and developed SDO Marinduque's Online IT Service Request System with 2FA through Email and SMS. This system digitalizes service request, ensuring timely response while ensuring data security."
    }
  ]
};
...
const bigProjects = {
  ...
  projects: [
    ...
    },
    {
      ...
      projectDesc: "An integrated mobile app that monitors and controls the environment within a prorotype enclosure, it also examines the food level percentage of the butterfly larvae inside and alert the farmers if the food run out or the system encounter some problems",
      footerLink: [
        {
          name: "Examine Website",
    ...
    },
    {
      ...
      projectName: "Rezidencia Faeldo's Online Food Ordering and Reservation System",
      projectDesc: "This is an online food ordering and reservation system for a restaurant within the province which aims to increase their quality of service, flexibility, and increase the reach of their target customers.",
      footerLink: [
        {
          name: "Examine Website",
    ...
    {
      image: require("./assets/images/DepEdMdq_logo.jfif"),
      projectName: "SDO Marinduque's Online IT Service Request System",
      projectDesc: "This is an online IT service request system for the Schools Division Office of Marinduque which aims to digitalize the process of requesting IT services, ensuring timely response while ensuring data security through 2FA via Email and SMS.",
      footerLink: [
        {
          name: "Examine Website",
          url: "https://deped-it-support-request-system-cbhd.onrender.com"
        }
      ]
    },
    {
      image: require("./assets/images/cafe_logo.jfif"),
      projectName: "Online Food Ordering and Reservation System with Integrated Cash Flow Monitoring ",
      projectDesc: "This is a tri-interface website (user, admin, and cashier) whose main goal is to employ flexibility and reach greater audience through online food ordering, allow and manage potential reservations, and monitor cash flow within the business to oversee where’s the business is heading in the future. ",
      footerLink: [
        {
          name: "Examine Website",
          url: "https://cafe-online-ordering-and-reservation.onrender.com"
        }
      ]
    }
  ],
...
const contactInfo = {
  ...
  subtitle:
    "Do you want to discuss a project? I'm open for opportunities!",
  number: "+910-353-8912",
